...
/// When demo mode is enabled (default), mockup data is shown.
/// When disabled, screens show empty states (ready for Firebase data).
class DemoModeService {
  ...
  /// false = demo mode disabled (show empty states)
  final ValueNotifier<bool> isDemoMode = ValueNotifier<bool>(true);
  ...
  Future<void> init() async {
    ...
    try {
      ...
      isDemoMode.value = prefs.getBool(_prefsKey) ?? true;
    } catch (e) {
      // If SharedPreferences fails, default to demo mode enabled
