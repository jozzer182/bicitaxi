...
/// Profile screen for the Bici Taxi Conductor app.
      ...
      child: SwitchListTile(
        secondary: Container(
          ...
          child: Icon(
            ...
            color: isDemoMode ? AppColors.driverAccent : Colors.black38,
            size: 22,
          ),
        ),
        title: const Text(
        ...
        value: isDemoMode,
        activeTrackColor: AppColors.driverAccent,
        onChanged: (value) {
          if (value) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          ...
          '• Los viajes y ganancias no son reales\n'
  ...
  Widget _buildSettingsItem(
    ...
    return ListTile(
      leading: Container(
        ...
        child: Icon(icon, color: AppColors.driverAccent, size: 22),
      ),
      title: Text(
        label,
