...
class AppUser {
  ...
  /// Whether this user is a driver (always true for conductor app)
  final bool isDriver;
  ...
  factory AppUser.fromMap(Map<String, dynamic> map) {
    return AppUser(
      ...
      isDriver: map['isDriver'] as bool? ?? true,
    );
  }
  ...
  @override
  String toString() {
    return 'AppUser(uid: $uid, email: $email, displayName: $displayName, isDriver: $isDriver)';
  }
