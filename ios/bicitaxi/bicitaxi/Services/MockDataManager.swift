...
class MockDataManager: ObservableObject {
    ...
    /// Demo user name (blank when mockup is disabled)
    var userName: String {
        isMockDataEnabled ? "Cliente Demo" : ""
    }
    
    /// Demo user handle/ID (blank when mockup is disabled)
    var userHandle: String {
        isMockDataEnabled ? "cliente-demo" : ""
    }
    
    /// Demo user email (blank when mockup is disabled)
    var userEmail: String {
        isMockDataEnabled ? "cliente@demo.com" : ""
    }
