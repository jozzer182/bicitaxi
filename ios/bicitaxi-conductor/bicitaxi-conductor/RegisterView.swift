...
struct RegisterView: View {
    ...
    private var formSection: some View {
        VStack(spacing: 12) {
            ...
            // Vehicle Info Field (optional)
            fieldContainer(label: "Tu bicicleta (opcional)", icon: "bicycle") {
    ...
    private func validateAndRegister() {
        ...
        authManager.register(name: name, email: email, password: password, phone: "", licenseNumber: "")
    }
}
